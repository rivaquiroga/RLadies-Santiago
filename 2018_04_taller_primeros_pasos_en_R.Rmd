...
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/gapminder_chile.png" align="center" height="100"></a>
...
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/gapminder_2007_PIB.png" align="center" height="250"></a>

#### Ordenar los casos

Los resultados del ejemplo anterior aparecen ordenados alfabéticamente, según el nombre del país. Sin embargo, en algunos casos podría interesarnos que sea otra variable la que defina el orden en que se muestran los resultados. Para eso podemos utilizar la función `arrange()`. 
Por ejemplo, si quisiéramos ver los datos del año 2007 de las tres Américas (norte, centro y sur) ordenados por expectativa de vida, podríamos usar el siguiente código:
...
gapminder %>% 
    ...
    summarise(mean(lifeExp))
```
Lo que les estamos pidiendo a R es que tome el objeto `gapminder`, luego, que filtre los casos del año 2007, luego, que agrupe los casos de acuerdo a la variable continente, luego, que haga un resumen de la información que sale de calcular la media de la expectativa de vida. 
