...
[En este tutorial se recoge parte del taller de introducción a R organizado por [RLadies Santiago](https://meetup.com/rladies-scl) y realizado por [Riva Quiroga](https://twitter.com/rivaquiroga)]

El objetivo de este tutorial acompañar a personas nuevas en R 
Desde la instalación de R y RStudio a la realización de algunos ejercicios de manipulación de datos. 
Hay muchas formas de acercarse a un nuevo lenguaje de programación; esta trata de ser lo más amable posible, sin recargar con demasiada información. 
...
En este taller utilizaremos R a través del IDE RStudio. ¿Qué es un IDE? IDE es el acrónimo de *Integrated Development Environment*: un *Entorno de Desarrollo Integrado*. Esto quiere decir que RStudio es una aplicación que nos entrega herramientas para hacer más fácil el desarrollo de proyectos usando R.
...
IMPORTANTE: Lo que hicimos recién fue cargar los código para esta sesión de R que estamos ejecutando actualmente. Si en algún momento cerraras el programa y retomaras este tutorial en otro momento, tendrías que volver a cargarlos. 
