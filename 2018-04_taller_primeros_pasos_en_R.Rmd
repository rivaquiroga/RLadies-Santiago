...
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/comentarios.png" align="center" width="50%"></a>
...
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/ejecutar_babynames.png" width="75%"></a>
...
tail(babynames, 10)
```
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/tail_babynames_10.png" align="center" width="50%"></a>
...
babynames %>% 
    filter(name == "Sansa")
```
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/sansas.png" align="center" width="60%"></a>
...
names(gapminder)
```
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/names_gapminder.png" align="center" width="60%"></a>
...
```
__ATENCIÓN:__ dependiendo de el ancho de tu ventana, puede que no se vea completa la segunda línea del código. Si pones el cursor sobre él, podrás moverte horizontalmente. De todos modos, lo pondremos de nuevo acá fuera del recuadro para que lo puedas ver:
...
```
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/names_gapminder_sudamerica.png" align="center" width="75%"></a>
...
______
¿Te pareció útil este tutorial? [Cuéntame](https://twitter.com/rivaquiroga) para saber si sigo desarrollando tutoriales de este tipo.
