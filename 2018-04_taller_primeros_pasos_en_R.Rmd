...
__Tutorial desarrollado a partir del taller de introducción a R organizado por [RLadies Santiago](https://meetup.com/rladies-scl) y realizado por [Riva Quiroga](https://twitter.com/rivaquiroga)__


> ¡Hola! El objetivo de este tutorial es acompañar a principiantes en el proceso que va desde la instalación de R a la manipulación inicial de datos. La idea es que sea algo práctico, pero suficientemente explicativo como para que se entienda qué es lo que hace un determinado bloque de código. El tutorial contiene muchas imágenes, con el fin de ir ilustrando el proceso tal como debieses verlo en tu computador. Debido a eso, no se ve muy bien en teléfonos móviles :( 
¿Te pareció útil? [Avísame](https://twitter.com/rivaquiroga), para saber si sigo desarrollando tutoriales de este tipo :)
...
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/comentarios.png" align="center" height="150"></a>
...
<a href="url"><img src="https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/babynames.png" height="300"></a>
...
```
__ATENCIÓN:__ dependiendo de el ancho de tu ventana, puede que no se vea completa la segunda línea del código. Si pones el cursor sobre él, podrás moverte horizontalmente.
