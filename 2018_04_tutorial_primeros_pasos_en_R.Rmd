...
Como señalamos antes, RStudio es un entorno que facilita el trabajo con R. Si solo abres R en tu computador, lo que verás es una consola. En ella escribes directamente el código que quieres ejecutar.

![](https://github.com/rivaquiroga/RLadies-Santiago/blob/master/images/r_consola.png)

Si abres RStudio verás que te aparece la misma consola, pero además te encontrarás con otros paneles:
...
Packages muestra la lista de paquetes que tienes instalados. 
