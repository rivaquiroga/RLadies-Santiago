...
```
__ATENCIÓN:__ dependiendo de el ancho de tu ventana, puede que no se vea completa la segunda línea del código. Si pones el cursor sobre el bloque de código, podrás moverte horizontalmente hasta el final. De todos modos, para que quede claro, el contenido de la segunda línea es:
> filter(country %in% c("Argentina", "Bolivia", "Brazil", "Chile", "Colombia", "Ecuador", "Paraguay", "Peru", "Uruguay", "Venezuela"))
